...
var calculador_component_1 = require("./calculador/calculador.component");
var AppComponent = function () {
    var _classDecorators = [(0, core_1.Component)({
            selector: 'app-root',
            standalone: true,
            imports: [router_1.RouterOutlet, formulario_component_1.FormularioComponent, calculador_component_1.CalculadorComponent],
